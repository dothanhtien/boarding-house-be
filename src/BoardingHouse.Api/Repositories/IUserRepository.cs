...
public interface IUserRepository : IRepository<User>
{
    ...
    Task<User?> GetByEmailWithRolesAndOrganizationsAsync(string email, CancellationToken cancellationToken = default);
    Task<User?> GetByIdWithRolesAndOrganizationsAsync(Guid id, CancellationToken cancellationToken = default);
